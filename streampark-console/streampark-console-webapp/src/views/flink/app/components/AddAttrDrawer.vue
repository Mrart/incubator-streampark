...
<script setup lang="ts" name="AddAttrDrawer">
  ...
  let initFormModel = reactive(JSON.parse(sessionStorage.getItem('AddJobModalParams') || '{}'))
  ...
  const [registerDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
    ...
    const parmas = {...data, checkPointFailur: Object.keys(data.checkPointFailure).length ? data.checkPointFailure : defaultCheckPointFailure}// init checkPoint失败策略 防止组件异步加载告警
